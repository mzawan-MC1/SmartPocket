          ...
          <div className="flex min-h-screen min-h-[100dvh] w-full items-stretch lg:h-screen lg:flex-row lg:overflow-hidden">
            ...
            {mobileSidebarOpen && (
              <div className="fixed inset-0 z-40 print:hidden lg:hidden">
                ...
                />
                <div
                  className={`absolute inset-y-0 z-10 min-h-0 h-[100dvh] w-[78vw] max-w-[288px] md:max-w-[304px] max-h-[100dvh] ${isRTL ? 'right-0' : 'left-0'} transition-transform duration-200 ease-out ${
            ...
            <div className="flex min-w-0 flex-1 flex-col overflow-x-hidden lg:h-screen lg:min-h-0 lg:overflow-hidden">
              ...
              <main
                ...
                className="min-h-0 flex-1 overflow-x-hidden scrollbar-thin pt-[calc(var(--main-topbar-clear,var(--topbar-height,56px))+0.25rem)] max-[768px]:pt-[calc(var(--main-topbar-clear,0px)+0.5rem)] max-[480px]:pt-[calc(var(--main-topbar-clear,0px)+0.375rem)] md:pt-1 lg:h-full lg:overflow-y-auto lg:overscroll-contain lg:pt-2"
