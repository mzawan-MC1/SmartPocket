...
export default function DashboardCharts({
  ...
  return (
    <section className="section-card h-full rounded-[28px] border border-border/80 bg-card shadow-card-sm transition-shadow duration-200 hover:shadow-card-md">
      <div className="flex flex-col gap-3 border-b border-border/70 px-5 py-[18px] max-[480px]:px-4 max-[480px]:py-3.5">
        <div className="grid grid-cols-1 gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-start lg:gap-4">
          ...
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_minmax(11.5rem,auto)] sm:items-center lg:w-[27rem]">
            ...
            />
            <div className="inline-flex min-w-0 items-center justify-center rounded-2xl border border-border/80 bg-muted/15 px-3 py-2 text-[11px] font-700 text-foreground shadow-card-sm sm:min-w-[11.5rem]">
              {activePeriod.label}
            </div>
          </div>
        </div>
      ...
      <div className="px-3 pb-3 pt-4 max-[480px]:px-2">
        <div>
